 ...
 */
export const LanguageStatsCard = ({ language, stats, colorScheme }) => {
            ...
            <Card.Body>
                ...
                >
                    ...
                    <Stat.Root>
                        ...
                        <Stat.ValueText fontSize="lg">{formatBytes(stats.total_size)}</Stat.ValueText>
                    </Stat.Root>
                ...
                <ProgessBarLabeled
                    ...
                    percentage={stats.percentage_files}
                />

                <Text fontSize="sm" fontWeight="medium">
                    {stats.percentage_files.toFixed(1)}%
                </Text>
                ...
                {stats.largest_file && (
                    <>
                        ...
                        >
                            ...
                            <Text
                                fontSize="sm"
                                title={stats.largest_file.path}
                                alignSelf="center"
                            >
                                {getFileName(stats.largest_file.path)} ({formatBytes(stats.largest_file.size)})
                            </Text>
                            ...
                            <Text
                                fontSize="sm"
                                alignSelf="center"
                                title={stats.smallest_file.size}
                            >
                                {getFileName(stats.smallest_file.path)} ({formatBytes(stats.smallest_file.size)})
                            </Text>
                        </VStack>
                    </>
                )}

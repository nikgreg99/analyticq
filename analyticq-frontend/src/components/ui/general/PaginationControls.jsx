...
const PaginationControls = ({
  ...
  showTooltip = true,
  showPageInfo = true,
  containerHeight = "64px", // Fixed height for the container
}) => {
  ...
  if (totalPages <= 1 || total === 0) return <Box height={containerHeight} />; // Return empty box with same height
  ...
  return (
    ...
    >
      <VStack align="center" width="auto" spacing={1}>
        <Flex
          alignSelf="center"
          justifyContent="center"
        ...
        {showPageInfo && (
          <Text fontSize="xs" color="Highlight" textAlign="center">
            {pageInfoText}
          </Text>
        )}
      </VStack>

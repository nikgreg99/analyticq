...
import { Box, Text, Button, Heading, Flex, Icon, Link } from "@chakra-ui/react";
...
export const IssueMetadataDisplay = ({ metadata }) => {
  if (!metadata || Object.keys(metadata).length === 0) {
    return (
      <Flex p={4} borderRadius="md" width="auto">
        <Text fontStyle="italic" textAlign="center" color="blackAlpha.800">
      ...
      <Flex align="flex-start">
        {isObject ? (
          <Button
            ...
            mr={1}
            aria-label={
              isExpanded ? `Collapse ${nodeKey}` : `Expand ${nodeKey}`
            }
...
IssueMetadataDisplay.displayName = "IssueMetadataDisplay";
